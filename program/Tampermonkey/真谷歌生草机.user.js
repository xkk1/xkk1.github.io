...
(function() {
    ...
    try {
        /*
        var gb_5d_gb_Vc = document.getElementsByClassName("gb_fd gb_6c"); // 它竟然变了，原来是“gb_5d gb_Vc” “gb_4d gb_1c”
        gb_5d_gb_Vc[0].textContent = 主菜单中翻译改为;
        gb_5d_gb_Vc[1].textContent = 左上翻译改为;
        */
        var gb_yc_a_span = document.querySelectorAll(".gb_yc>a>span");
        gb_yc_a_span[1].textContent = 主菜单中翻译改为;
        gb_yc_a_span[3].textContent = 左上翻译改为;
